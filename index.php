...
<body>
  ...
  <section>
    ...
    <div class="register">
        ...
        <input type = "password" placeholder = "confirm password" name = "confirm-password" id = "register-password-2"><br>
             ...
             $.ajax({
              ...
              success : function(data){
                 if(data == 1){
                    ...
                    window.open("http://localhost/chat-host20/chat room/index.php","_self");
                 }else{
